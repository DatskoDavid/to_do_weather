...
class TasksBloc extends Bloc<TasksEvent, TasksState> {
  ...
  void _addTask(AddTask event, Emitter<TasksState> emit) async {
    final updated = await _repository.addTask(event.task);
  ...
  void _setOnEdit(_, Emitter<TasksState> emit) =>
      emit(state.copyWith(isOnEdit: true));

  void _setOffEdit(_, Emitter<TasksState> emit) =>
      emit(state.copyWith(isOnEdit: false));
