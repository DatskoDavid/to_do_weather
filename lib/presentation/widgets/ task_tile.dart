      ...
      child: ScaleTransition(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color:
                widget.task.isDone ? AppColors.doneBackground : AppColors.white,
            borderRadius:
                const BorderRadius.all(Radius.circular(AppRadius.normal)),
          ),
          child: Row(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: AppColors.outline.withOpacity(opacity), width: 1),
        ),
        child: Icon(
          Icons.done,
          size: AppSize.small,
          color: isDone
              ? AppColors.outline.withOpacity(opacity)
...
class _Title extends StatelessWidget {
  ...
  const _Title({Key? key, required this.title, required this.opacity})
      : super(key: key);
